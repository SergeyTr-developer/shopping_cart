...
import { form, productList, basketList } from '../selectors/selectors'
import { Notification } from '../components/notification'
import { addToBasketAndUpdateLocalStorage, updateBasketFromLocalStorage } from '../products/localStorage'
...
export function addProductToBasket(event) {
  ...
  if (product) {
    ...
    console.log(product)
    generateProductCardHTML(product, basketList, false)
    addToBasketAndUpdateLocalStorage(product)
